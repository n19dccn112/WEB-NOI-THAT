...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query(value = "select o.orderId as orderId, o.status as status, ud.first_name as firstName, ud.last_name as lastName, ud.address as uAddress, o.address as address," +
            ...
            " where u.id=?1 AND o.status=?2", nativeQuery = true)
    List<OrderDetailView> getAllOrderByUserId(Long userId, String status);
}

...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Blog Post</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">Blog Post</li>
                </ul>
...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-blog-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:08 GMT -->
</html>
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Sale Products</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">SALE PRODUCTS</li>
                </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    <h1>Sale products</h1>
                    <p>Browse our sale products to catch up with the trend.</p>
                </div>

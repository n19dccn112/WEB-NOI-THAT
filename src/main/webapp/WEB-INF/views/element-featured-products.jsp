...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-featured-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:05 GMT -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Featured Products</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">FEATURED PRODUCTS</li>
                </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    ...
                    <p>Browse our featured products to catch up with the trend.</p>
                </div>

        ...
        <div id="rev_slider_9_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
            <ul>
                ...
                <li data-index="rs-21"
                    ...
                    <!-- LAYER NR. 3 -->
                    <a class="tp-caption button-only-text rev-btn  tp-resizeme" href="shop-left-sidebar.html" target="_blank"
            ...
            <div class="col-lg-12">
                <div class="fashion-home-intro">
                    ...
                    <p class="description">Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse suscipit
                        ...
                        cing elit.</p>
                    <a href="shop-left-sidebar.html" class="lezada-shop-link">SHOP COLLECTION</a>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-6 mb-100">
                ...
                <span class="wishlist"><a href="#" data-tippy="Add to wishlist" data-tippy-inertia="true"
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html"> Dark Brown Bag</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
            ...
            <div class="col-lg-4 col-md-6 mb-100">
                ...
                <span class="wishlist"><a href="#" data-tippy="Add to wishlist" data-tippy-inertia="true"
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Dark Brown Shoe</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="shop-left-sidebar.html" class="lezada-button lezada-button--medium lezada-button--icon--left"> <i
                        class=" ion-plus"></i>
                    shop more</a>
            </div>
        </div>
            ...
            <div class="col-lg-4 mb-50 mb-lg-0">
                ...
                <div class="blog-intro">
                    ...
                    <p>Lorem ipsum dolor sit amet, consecte tur cing elit. Suspe ndisse suscipit sagittis leo sit
                        met condim entum.</p>
                    <a href="blog-standard-left-sidebar.html" class="lezada-button lezada-button--medium">view
                        all</a>
                </div>
                        ...
                        <div class="col">
                            <div class="single-slider-post">
                                ...
                                <div class="single-slider-post__content">
                                    ...
                                    <h2 class="post-title"><a href="blog-single-post-left-sidebar.html">Chic Fashion
                                        Phenomenon</a></h2>
                                    ...
                                    <a href="blog-single-post-left-sidebar.html" class="blog-readmore-btn">read
                                        more</a>
                                </div>
                        ...
                        <div class="col">
                            <div class="single-slider-post">
                                ...
                                <div class="single-slider-post__content">
                                    ...
                                    <h2 class="post-title"><a href="blog-single-post-left-sidebar.html">Shirt Color
                                        Picking Guide</a></h2>
                                    <p class="post-excerpt">Michele seemed to say, was the 21st-century Gucci girl,
                                        an eccentric, fresh-faced weirdo who wasn’t afraid to wear backless
                                        fur-lined loafers, to personify the idea of “ugly pretty.”</p>
                        ...
                        <div class="col">
                            <div class="single-slider-post">
                                ...
                                <div class="single-slider-post__content">
                                    ...
                                    <h2 class="post-title"><a href="blog-single-post-left-sidebar.html">Perfect
                        ...
                        <div class="col">
                            <div class="single-slider-post">
                                ...
                                <div class="single-slider-post__content">
                                    ...
                                    <h2 class="post-title"><a href="blog-single-post-left-sidebar.html">T-Shirts as

...
<div class="shop-page-wrapper grey-bg pt-100 pb-100 border-bottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<div class="shop-product-description-tab-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <!--=======  shop product description tab  =======-->

                <div class="shop-product__description-tab border-top-0 pt-100 pb-100">
                    <!--=======  tab navigation  =======-->

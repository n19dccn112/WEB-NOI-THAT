...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/blog-masonry-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:34 GMT -->
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-1 mb-md-70 mb-sm-70">
        ...
        <div class="row blog-post-wrapper blog-post-wrapper--masonry">
          <!--=======  single slider post  =======-->
          <div class="col-lg-6 col-md-6 single-slider-post grid-item mb-40">
            <!--=======  image  =======-->

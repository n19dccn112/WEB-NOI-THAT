...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-instagram.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:16 GMT -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Instagram</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">Instagram</li>
                </ul>
    ...
    <div class="container wide">
        <div class="row align-items-center">
            ...
            <div class="col-lg-8">
                ...
                <div class="instagram-image-area">
                    <!--=======  instagram image container  =======-->

                    <div class="instagram-image-slider-container">
                        <div class="instagram-feed-thumb">
                            <div id="instagramFeed" class="instagram-grid">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    ...
                    <p>This is where to find your satisfactory products</p>
                    <div class="instagram-section-intro mt-80">
                        <p><a href="#">@lezada_shop</a></p>
                    </div>
                </div>
...
<div class="instagram-image-slider-area mb-100">

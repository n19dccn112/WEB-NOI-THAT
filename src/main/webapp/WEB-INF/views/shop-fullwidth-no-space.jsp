...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/shop-fullwidth-no-space.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:07:14 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="col-12 col-lg-5 col-md-2">
                    ...
                    <div class="filter-icons">
                        ...
                        <div class="single-icon grid-icons">
                            ...
                            <a data-target="four-column" href="javascript:void(0)"><i
    ...
    <div class="shop-page-content mb-100">
        <div class="row">
            ...
            <div class="col-lg-12 order-1 order-lg-2 mb-md-80 mb-sm-80">
                ...
                <div class="row no-gutters product-isotope shop-product-wrap five-column">

                    <!--=======  single product  =======-->
                    <div class="col-12 col-lg-is-5 col-md-6 col-sm-6 hot sale">
                    ...
                    <!--=======  single product  =======-->
                    <div class="col-12 col-lg-is-5 col-md-6 col-sm-6 sale">
                        <div class="single-product single-product--smarthome">
                            <!--=======  single product image  =======-->
                    ...
                    <!--=======  single product  =======-->
                    <div class="col-12 col-lg-is-5 col-md-6 col-sm-6 hot">
                        <div class="single-product single-product--smarthome">
                            <!--=======  single product image  =======-->
                    ...
                    <!--=======  single product  =======-->
                    <div class="col-12 col-lg-is-5 col-md-6 col-sm-6 new">
                        <div class="single-product single-product--smarthome">
                            <!--=======  single product image  =======-->
                    ...
                    <!--=======  End of single product  =======-->
                    <!--=======  single product  =======-->
                    <div class="col-12 col-lg-is-5 col-md-6 col-sm-6 sale hot">
                        <div class="single-product single-product--smarthome">
                            <!--=======  single product image  =======-->

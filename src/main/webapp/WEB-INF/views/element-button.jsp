...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-button.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:16 GMT -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Buttons</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">Buttons</li>
                </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    <h1>Small buttons</h1>
                    <p>This is how small buttons look on your site.</p>
                </div>
...
<div class="button-container mb-100">
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 mb-md-30  mb-sm-30">

                <!--=======  single button  =======-->

                <button class="lezada-button lezada-button--small">DEFAULT STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-md-30 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--small">ALTERNATIVE STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--small lezada-button--custom ">CUSTOM STYLE</button>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--small lezada-button--icon lezada-button--icon--left"> <i
                        class="fa fa-adjust"></i> ICON LEFT</button>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    ...
                    <p>This is how medium buttons look on your site.</p>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 mb-md-30  mb-sm-30">
                ...
                <button class="lezada-button lezada-button--medium">DEFAULT STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-md-30 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--medium">ALTERNATIVE STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--medium lezada-button--custom ">CUSTOM STYLE</button>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--medium lezada-button--icon lezada-button--icon--right"> ICON RIGHT
...
<!--=====  End of medium button container  ======-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    <h1>Large buttons</h1>
                    <p>This is how large buttons look on your site.</p>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 mb-md-30  mb-sm-30">
                ...
                <button class="lezada-button lezada-button--large">DEFAULT STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-md-30 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--large">ALTERNATIVE STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--large lezada-button--custom ">CUSTOM STYLE</button>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--large lezada-button--icon lezada-button--icon--left"> <i
                        class="fa fa-adjust"></i> ICON LEFT</button>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    <h1>Extra large buttons</h1>
                    <p>This is how extra large buttons look on your site.</p>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 mb-md-30  mb-sm-30">
                ...
                <button class="lezada-button lezada-button--xl">DEFAULT STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-md-30 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--xl">ALTERNATIVE STYLE</button>
            ...
            <div class="col-lg-3 col-md-6 mb-sm-30">
                ...
                <button class="lezada-button lezada-button--xl lezada-button--custom ">CUSTOM STYLE</button>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--xl lezada-button--icon lezada-button--icon--right"> ICON RIGHT <i
...
<!--=====  End of extra large button container  ======-->

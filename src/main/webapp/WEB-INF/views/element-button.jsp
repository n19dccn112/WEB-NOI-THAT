        ...
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--small lezada-button--icon lezada-button--icon--left"><i
                        class="fa fa-adjust"></i> ICON LEFT
                </button>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--medium lezada-button--icon lezada-button--icon--right"> ICON
                    RIGHT
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <button class="lezada-button lezada-button--xl lezada-button--icon lezada-button--icon--right"> ICON
                    RIGHT <i

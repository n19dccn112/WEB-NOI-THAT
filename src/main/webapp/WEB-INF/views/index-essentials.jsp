                ...
                <div class="row product-isotope">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45 new sale">
                        <div class="single-product">
                            ...
                            <div class="single-product__content">
                                <div class="title">
                                    <h3> <a href="shop-product-basic.html">Black Shoe</a></h3>
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45 sale">
                        <div class="single-product">
                            ...
                            <div class="single-product__content">
                                <div class="title">
                                    <h3> <a href="shop-product-basic.html">Polo T-shirt</a></h3>
                                    <a href="#">Add to cart</a>
                                </div>
                                <div class="price">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45 new">
                        <div class="single-product">
                            ...
                            <div class="single-product__content">
                                <div class="title">
                                    <h3> <a href="shop-product-basic.html">Loafer Mule</a></h3>
                                    <a href="#">Add to cart</a>
                                </div>
                                <div class="price">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45 new sale">
                        <div class="single-product">
                            ...
                            <div class="single-product__content">
                                <div class="title">
                                    <h3> <a href="shop-product-basic.html">Black Bag</a></h3>
                                    <a href="#">Add to cart</a>
                                </div>
                                <div class="price">

...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Product Widget</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">PRODUCT WIDGET</li>
                </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    ...
                    <p>Available widget to control your site’s products.</p>
                </div>
...
<!--=============================================
  =            product widget slider container         =
  =============================================-->

<div class="product-widget-slider-container mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-md-70 mb-sm-70">
                <!--=======  single product widget slider container  =======-->

                <div class="single-product-widget-slider-container">
                    <h3 class="widget-slider-title" id="append-arrow-1">New Products</h3>

                    <!--=======  single product widget slider  =======-->

                    <div class="lezada-slick-slider single-product-widget-slider" data-slick-setting='{
                                "slidesToShow": 1,
                                "slidesToScroll": 1,
                                "rows": 3,
                                "arrows": true,
                            ...
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__image">
                                    <a href="shop-product-basic.html">
                                        <img src="assets/images/products/bag-1-1-120x160.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Big Size Backpack</a></h3>
                                        <div class="price">
                                    ...
                                    <div class="single-widget-product__content__bottom">
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__bottom">
                                        <a class="cart-btn" href="#">Select options</a>
                                    </div>
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Pink Clay</a></h3>
                                        <div class="price">
                                            <span class="main-price discounted">$20.00</span>
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Big Size Sofa</a></h3>
                                        <div class="price">
                                            <span class="main-price discounted">$360.00</span>
                                            <span class="discounted-price">$330.00</span>
                                        </div>
                                        <div class="rating">
                                            <i class="ion-android-star"></i>
                                            <i class="ion-android-star"></i>
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Light Brown Watch</a></h3>
                                        <div class="price">
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Black Watch</a></h3>
                                        <div class="price">
                                            <span class="main-price discounted">$260.00</span>
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic.html">Leather Belt Watch</a></h3>
                                        <div class="price">
                                            <span class="main-price discounted">$160.00</span>
            ...
            <div class="col-lg-4 col-md-6 mb-sm-70">
                <!--=======  single product widget slider container  =======-->

                <div class="single-product-widget-slider-container">
                    <h3 class="widget-slider-title" id="append-arrow-2">Top Rated</h3>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-product-widget-slider-container">
                    <h3 class="widget-slider-title" id="append-arrow-3">Featured Products</h3>
...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-product-widget.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:05 GMT -->
</html>
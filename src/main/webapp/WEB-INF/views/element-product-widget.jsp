                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic">Pink Clay</a></h3>
                                        <div class="price">
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic">Big Size Sofa</a></h3>
                                        <div class="price">
                        ...
                        <div class="single-widget-product-wrapper">
                            <div class="single-widget-product">
                                ...
                                <div class="single-widget-product__content">
                                    ...
                                    <div class="single-widget-product__content__top">
                                        <h3 class="product-title"><a href="shop-product-basic">Black Watch</a></h3>
                                        <div class="price">
                                            <span class="main-price discounted">$260.00</span>

            ...
            <div class="col-md-4 mb-30">
                ...
                <div class="single-category single-category--three">
                    ...
                    <div
                        ...
                        <div class="title">
                            <p><a href="shop-left-sidebar.html">Wooden <span>Chair</span></a></p>
            ...
            <div class="col-md-4 mb-30">
                ...
                <div class="single-category single-category--three">
                    ...
                    <div
                            class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
                        <div class="title">
                            <p><a href="shop-left-sidebar.html">Thumbler <span>Alarm Clock</span></a></p>
                            <a href="shop-left-sidebar.html">Shop Now</a>
                        </div>
            ...
            <div class="col-md-4 mb-30">
                ...
                <div class="single-category single-category--three">
                    ...
                    <div
                            class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
                        <div class="title">
                            <p><a href="shop-left-sidebar.html">Home <span>Decoration</span></a></p>
                            <a href="shop-left-sidebar.html">Shop Now</a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Wooden Tool Table</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
                            <span class="main-price discounted">$400.00</span>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Candle Holder</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
                            <span class="main-price">$85.00</span>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Glass Candle Holder</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
                            <span class="main-price discounted">$400.00</span>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Wooden Tool</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
                            <span class="main-price">$85.00</span>
                        ...
                        <ul>
                            ...
                            <li data-index="rs-14" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                                ...
                                <div class="tp-caption Slider-button-alt rev-btn " id="slide-14-layer-12"
                                    ...
                                    <a class="revslider-button" href="shop-left-sidebar.html"> ONLY $39</a>
                                </div>
                            </li>
                        </ul>
                        <div class="tp-bannertimer tp-bottom" style="visibility: hidden !important;"></div>

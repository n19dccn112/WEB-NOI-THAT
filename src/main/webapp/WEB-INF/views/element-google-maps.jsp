...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-google-maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:16 GMT -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Google Maps</h1>

                <!--=======  breadcrumb list  =======-->

                <ul class="breadcrumb-list">
                    <li class="breadcrumb-list__item"><a href="index-2.html">HOME</a></li>
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">google maps</li>
                </ul>
...
<div class="section-title-container mb-70">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <!--=======  section title  =======-->
...
<div class="wide-layout-map-area mb-100">
    <!--=======  box layout map container  =======-->

    <div class="box-layout-map-container">
        <div class="google-map google-map--style-2" id="google-map-two"></div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title--one text-center">
                    <h1>Colored styles options</h1>
                    <p>All google maps style</p>
                </div>
...
<div class="group-map-area mb-100 mb-md-70 mb-sm-70">
    <div class="group-map-container">
        <!--=======  single map  =======-->

        <div class="single-map mb-md-30 mb-sm-30">
            <div class="google-map google-map--style-3" id="google-map-three"></div>
        </div>
        ...
        <div class="single-map mb-md-30 mb-sm-30">
            <div class="google-map google-map--style-3" id="google-map-four"></div>
        </div>
        ...
        <div class="single-map mb-md-30 mb-sm-30">
            <div class="google-map google-map--style-3" id="google-map-five"></div>
        </div>
...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-google-maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:17 GMT -->
</html>

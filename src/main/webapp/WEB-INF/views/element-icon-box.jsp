...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Icon Box</h1>

                <!--=======  breadcrumb list  =======-->

                <ul class="breadcrumb-list">
                    <li class="breadcrumb-list__item"><a href="index-2.html">HOME</a></li>
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">icon box</li>
                </ul>
            ...
            <div class="col-md-4 mb-sm-30">
                <div class="single-icon-box single-icon-box--grey-center-iconbox">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">Phone 01: +84 01122000</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-sm-30">
                <div class="single-icon-box single-icon-box--grey-center-iconbox">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">1800 Abbot Kinney Blvd. <br> Unit D, Venice</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-sm-30">
                <div class="single-icon-box single-icon-box--grey-center-iconbox">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">lezadastore@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="icon-box-area icon-box-area--feature-icon pt-50 pb-20 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-md-30 mb-sm-30">
                ...
                <div class="single-icon-box single-icon-box--feature-icon">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">100% money back guarantee</p>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-md-30 mb-sm-30">
                ...
                <div class="single-icon-box single-icon-box--feature-icon">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">Free shipping on all orders over $99</p>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-md-30 mb-sm-30">
                ...
                <div class="single-icon-box single-icon-box--feature-icon">
                    ...
                    <div class="icon-box-content">
                        ...
                        <p class="content">Live fast and good support 24/7.</p>
                    </div>
                </div>
...
<div class="icon-box-area mb-100 mb-sm-70">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-4">
                <div
                        class="single-icon-box single-icon-box--color-center-iconbox  single-icon-box--color-center-iconbox--green">
                    <div class="icon-box-icon">
                        <i class="ti-mobile"></i>
                    </div>
                    <div class="icon-box-content">
            ...
            <div class="col-md-4">
                <div
                        class="single-icon-box single-icon-box--color-center-iconbox single-icon-box--color-center-iconbox--yellow">
                    <div class="icon-box-icon">
                        <i class="ti-location-pin"></i>
                    </div>
                    <div class="icon-box-content">
            ...
            <div class="col-md-4">
                <div
                        class="single-icon-box single-icon-box--color-center-iconbox single-icon-box--color-center-iconbox--blue">
                    <div class="icon-box-icon">
                        <i class="ti-email"></i>
                    </div>
                    <div class="icon-box-content">

...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/shop-order-tracking.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:07:50 GMT -->
<!-- Added by HTTrack -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-130">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Order Tracking</h1>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-10 col-12 offset-lg-3 offset-md-1">
                ...
                <div class="order-tracking-box pt-50 pr-50 pb-50 pl-50  pt-xxs-40 pr-xxs-20 pb-xxs-40 pl-xxs-20">
                    <p class="info-text mb-20">To track your order please enter your Order ID in the box below and press
                        the
                        "Track" button. This was given to you on your receipt and in the confirmation email you should
                        have
                        received.</p>
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-40">
                                    <button class="lezada-button lezada-button--medium order-tracking-button">track
                                    </button>
                                </div>
                            </div>
                        </form>

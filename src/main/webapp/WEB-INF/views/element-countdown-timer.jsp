...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/element-countdown-timer.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:08:16 GMT -->
...
<div class="breadcrumb-area breadcrumb-bg-1 pt-50 pb-70 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="breadcrumb-title">Countdown Timer</h1>
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-list__item breadcrumb-list__item--active">COUNTDOWN TIMER</li>
                </ul>
...
<div class="countdown-timer-area mb-100">
    <div class="container wide">
        <div class="row">
            <div class="col-lg-12">
...
<div class="countdown-timer-area mb-100 countdown-background countdown-bg-2 pt-100 pb-100">
    <div class="container wide">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">

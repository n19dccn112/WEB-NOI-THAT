...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/shop-product-extra-content.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:07:40 GMT -->
<!-- Added by HTTrack -->
...
<div class="shop-page-wrapper mt-100 mb-75">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<div class="shop-product-description-tab-are mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <!--=======  shop product description tab  =======-->

                <div class="shop-product__description-tab border-top-0">
                    <!--=======  tab navigation  =======-->
    ...
    <div class="tab-content" id="nav-tabContent2">
        ...
        <div class="tab-pane fade show active" id="product-series-1" role="tabpanel" aria-labelledby="product-tab-1">
            ...
            <div class="shop-product__extra-info-area">

                <div class="shop-product__extra-info pt-30 pb-30">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-5 col-md-6 mb-sm-50">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>Ion coated stainless steel</td>
                                    </tr>
                                    <tr>
                                        <td>Movement:</td>
                                        <td>Miyota 2035 Japanese quartz movement</td>
                                    </tr>
                                    <tr>
                                        <td>Accuracy:</td>
                                        <td>+- 20 second / month</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-lg-6 offset-lg-1 col-md-6">
                                ...
                                <div class="shop-product__extra-info-image">
                                    <img src="assets/images/shop-product/description-watches.png" class="img-fluid"
                                         alt="">
                                </div>

                                <!--=======  End of extra info image  =======-->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="shop-product__extra-info-video d-none d-sm-block">
                    <div class="video-bg player" data-url="https://www.youtube.com/watch?v=3ypJQZwNNIc"></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="shop-product__review m-auto">
                            <h2 class="review-title mb-20 text-center">3 reviews for High-waist Trousers</h2>
                            ...
                            <div class="single-review">
                                ...
                                <div class="single-review__content">
                                    ...
                                    <p class="message">
                                        I didn’t expect this poster to arrive folded. Now there are lines on the poster
                                        and one sad Ninja.
                                    </p>
...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/shop-product-extra-content.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:07:41 GMT -->
</html>
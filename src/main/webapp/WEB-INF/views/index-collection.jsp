...
<div class="slider-area mb-100 mb-md-90 mb-sm-80">
    <div id="rev_slider_8_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="homepage-2"
        ...
        <div id="rev_slider_8_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.7">
            <ul>
                ...
                <li data-index="rs-18"
                    ...
                    <div class="tp-caption Slider-button-alt-white rev-btn  tp-resizeme" id="slide-18-layer-20"
                         ...
                         data-actions='[{"event":"click","action":"simplelink","target":"_blank","url":"\/shop-left-sidebar.html","delay":""}]'
                        ...
                        <a class="revslider-button-white" href="shop-left-sidebar.html"> SHOP NOW</a>
                    </div>
         ...
         href="/shop-left-sidebar.html" target="_self"			 id="slide-18-layer-25"
                    ...
                    <!-- LAYER NR. 8 -->
                    <!-- <a class="tp-caption   tp-resizeme"
         href="/shop-left-sidebar.html" target="_self"			 id="slide-18-layer-26"
                    ...
                    <!-- LAYER NR. 9 -->
                    <!-- <a class="tp-caption   tp-resizeme"
         href="/shop-left-sidebar.html" target="_self"			 id="slide-18-layer-27"
                ...
                <li data-index="rs-19"
                    ...
                    <!-- LAYER NR. 17 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-19-layer-25"
                       data-x="['left','center','center','left']" data-hoffset="['215','-328','-598','-393']"
                       data-y="['top','middle','middle','top']" data-voffset="['680','55','119','23']"
                    ...
                    <!-- LAYER NR. 18 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-19-layer-26"
                       data-x="['left','center','center','left']" data-hoffset="['215','-354','-661','-292']"
                       data-y="['top','middle','middle','top']" data-voffset="['760','130','-27','251']"
                       data-fontsize="['34','34','100','60']" data-lineheight="['72','72','100','90']"
                       data-color="['rgb(255,255,255)','rgb(255,255,255)','rgb(51,51,51)','rgb(51,51,51)']" data-width="none"
                    ...
                    <!-- LAYER NR. 19 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-19-layer-27"
                ...
                <li data-index="rs-20" data-transition="curtain-1,curtain-2,3dcurtain-horizontal,3dcurtain-vertical,cube"
                    ...
                    <!-- LAYER NR. 26 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-20-layer-25"
                    ...
                    <!-- LAYER NR. 27 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-20-layer-26"
                       data-x="['left','center','center','left']" data-hoffset="['215','-354','-661','-292']"
                       data-y="['top','middle','middle','top']" data-voffset="['760','130','-27','251']"
                       data-fontsize="['34','34','100','60']" data-lineheight="['72','72','100','90']"
                       data-color="['rgb(255,255,255)','rgb(255,255,255)','rgb(51,51,51)','rgb(51,51,51)']" data-width="none"
                    ...
                    <!-- LAYER NR. 28 -->
                    <a class="tp-caption   tp-resizeme" href="https://htmldemo.hasthemes.com/shop-left-sidebar.html" target="_blank" id="slide-20-layer-27"
                       data-x="['left','center','center','left']" data-hoffset="['214','-353','-654','-390']"
...
<div class="footer-container footer-two pt-100">
    <div class="container wide">
        <div class="row">
            ...
            <div class="col footer-single-widget">
                <p class="footer-email"><a href="mailto:contact@lezada.com">contact@lezada.com</a></p>
                <p class="footer-phone">(+88) 123 4566 6868</p>

                <div class="store-icons">
                    <img src="assets/images/icons/app.png" class="img-fluid" alt="">
                </div>
            </div>
            ...
            <div class="col footer-single-widget">
                ...
                <div class="footer-subscription-widget footer-subscription-widget--change-subscription-style">
                    ...
                    <div class="mailchimp-alerts">
                        ...
                        <div class="mailchimp-success-2"></div><!-- mailchimp-success end -->
                        <div class="mailchimp-error-2"></div><!-- mailchimp-error end -->
        ...
        <div class="row align-items-center mt-50 pb-15">
            <div class="col-lg-4 col-md-4 col-sm-12 footer-single-widget mb-0 mb-sm-50">
                <!--=======  copyright text  =======-->
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 footer-single-widget text-left text-md-center mb-0 mb-sm-50">
                <!--=======  logo  =======-->
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 footer-single-widget text-left text-md-right">
                <!--=======  payment icon  =======-->

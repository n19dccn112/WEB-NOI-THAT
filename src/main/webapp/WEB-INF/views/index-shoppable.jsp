...
<div class="home-content home-content--shoppable">
    ...
    <div class="col-md-6">
      ...
      <div class="single-shoppable single-shoppable--width-half">
        ...
        <div class="cloth-tag" data-top="50%" data-left="60%">
          ...
          <div class="cloth-tag__content">
            <div class="cloth-tag__content__image">
              <img src="assets/images/products/wide-leg-crop-pant-black-120x132.jpg" class="img-fluid" alt="">
            </div>
            <div class="cloth-tag__content__content">
    ...
    <div class="col-lg-4 col-md-4">
      ...
      <div class="single-shoppable single-shoppable--width-onethird">
        ...
        <div class="cloth-tag" data-top="60%" data-left="55%">
          ...
          <div class="cloth-tag__content">
            <div class="cloth-tag__content__image">
              <img src="assets/images/products/wide-leg-crop-pant-brown-600x800.jpg" class="img-fluid" alt="">
            </div>
            <div class="cloth-tag__content__content">
              <h1>Brown Pant</h1>
              <p class="price"><span class="main-price">$40</span></p>
    ...
    <div class="col-lg-4 col-md-4">
      ...
      <div class="single-shoppable single-shoppable--width-onethird">
        ...
        <div class="cloth-tag" data-top="60%" data-left="45%">
          ...
          <div class="cloth-tag__content">
            <div class="cloth-tag__content__image">
              <img src="assets/images/products/wide-leg-crop-pant-brown-120x132.jpg" class="img-fluid" alt="">
            </div>
            <div class="cloth-tag__content__content">
              <h1>Brown Pant</h1>
              <p class="price"><span class="main-price">$40</span></p>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="single-shoppable single-shoppable--width-onefourth">
            ...
            <div class="cloth-tag" data-top="30%" data-left="50%">
              ...
              <div class="cloth-tag__content">
                <div class="cloth-tag__content__image">
                  <img src="assets/images/products/tank-crop-black-120x132.jpg" class="img-fluid" alt="">
                </div>
                <div class="cloth-tag__content__content">
                  <h1>Relaxed T-Shirt</h1>
                  <p class="price"><span class="main-price">$30</span></p>
            ...
            <div class="cloth-tag" data-top="60%" data-left="35%">
              ...
              <div class="cloth-tag__content">
                <div class="cloth-tag__content__image">
                  <img src="assets/images/products/wide-leg-crop-pant-bone-120x132.jpg" class="img-fluid" alt="">
                </div>
                <div class="cloth-tag__content__content">
                  <h1>Black Pant</h1>
                  <p class="price"><span class="main-price">$40</span></p>
  ...
  <div class="shop-button text-center w-100 mt-80 mb-100">
    <a class="lezada-button lezada-button--medium lezada-button--icon--left" href="shop-left-sidebar.html"> <i

        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-30">
                <div class="cosmetics-home-intro">
                    ...
                    <a href="shop-left-sidebar.html" class="lezada-shop-link">LEARN MORE</a>
                        ...
                        <ul>
                            ...
                            <li data-index="rs-48" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                                ...
                                <div class="tp-caption button-under-line rev-btn " id="slide-48-layer-4"
                                    ...
                                    <a class="revslider-button-red" href="shop-left-sidebar.html"> SHOP NOW</a>
                                </div>
                            </li>
                        </ul>
                        <div class="tp-bannertimer tp-bottom" style="visibility: hidden !important;"></div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        ...
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Jesmine green tea</a></h3>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Coco rose body lotion</a></h3>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Coconut milk bath soak</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        <div class="title">
                            <h3> <a href="shop-product-basic.html"> Jasemin body oil</a></h3>
                            <a href="#">Add to cart</a>
                        </div>
                        <div class="price">

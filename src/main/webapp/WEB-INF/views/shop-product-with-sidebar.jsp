...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/shop-product-with-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:07:40 GMT -->
<!-- Added by HTTrack -->
                            ...
                            <div class="page-sidebar">
                                ...
                                <div class="single-sidebar-widget mb-40">
                                    ...
                                    <ul class="single-sidebar-widget--list single-sidebar-widget--list--category">
                                        ...
                                        <li><a href="shop-left-sidebar">Watches </a> <span class="quantity">12</span>
                                        </li>
                                        <li><a href="shop-left-sidebar">Bags </a> <span class="quantity">22</span></li>
                                        <li><a href="shop-left-sidebar">Uncategorized </a> <span
                                                class="quantity">14</span></li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="widget-product-wrapper">
                                            ...
                                            <div class="single-widget-product">
                                                ...
                                                <div class="single-widget-product__content">
                                                    ...
                                                    <div class="single-widget-product__content__top">
                                                        <h3 class="product-title"><a href="shop-product-basic">Wooden
                                                            Table</a></h3>
                                                        <div class="price">
                                        ...
                                        <div class="single-widget-product-wrapper">
                                            <div class="single-widget-product">
                                                ...
                                                <div class="single-widget-product__image">
                                                    <a href="shop-product-basic">
                                                        <img src="assets/images/products/soccer-4-100x100.jpg"
                                                             class="img-fluid" alt="">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="single-widget-product__content">
                                                    ...
                                                    <div class="single-widget-product__content__top">
                                                        <h3 class="product-title"><a href="shop-product-basic">High
                                                            waist trousers</a></h3>
                                                        <div class="price">

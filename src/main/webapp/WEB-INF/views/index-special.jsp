        ...
        <div id="rev_slider_15_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
            <ul>
                ...
                <li data-index="rs-39"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="assets/images/revimages/dummy.png" data-bgcolor='#e9f0f1' style='background:#e9f0f1'
                         alt=""
                    ...
                    <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme" id="slide-39-layer-32"
                         ...
                         data-width="['526','526','403','281']" data-height="['526','526','403','281']"
                    ...
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption   tp-resizeme" id="slide-39-layer-17"
                    ...
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme" id="slide-39-layer-18"
                         data-x="['left','center','left','left']"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-39-layer-30" data-x="['left','left','left','right']"
                         ...
                         data-voffset="['-595','-428','0','-4']" data-width="none" data-height="none"
                         data-whitespace="nowrap"
                         ...
                         style="z-index: 9;"><img src="assets/images/revimages/dummy.png" alt=""
                                                  data-ww="['680auto','540px','408px','270px']"
                                                  data-hh="['1467','1165px','880px','583px']"
                                                  data-lazyload="assets/images/revimages/special/hp3-element-1.png"
                                                  data-no-retina></div>

                    <!-- LAYER NR. 6 -->
                    <div class="tp-caption   tp-resizeme" id="slide-39-layer-13"
                    ...
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme" id="slide-39-layer-3"
                ...
                <li data-index="rs-40"
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="assets/images/revimages/dummy.png" data-bgcolor='#f6f6f6' style='background:#f6f6f6'
                         alt=""
                         data-lazyload="assets/images/revimages/transparent.png" data-bgposition="center center"
                         data-bgfit="cover"
                         data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <!-- LAYER NR. 9 -->
                    <div class="tp-caption   tp-resizeme" id="slide-40-layer-17"
                         data-x="['left','center','left','left']"
                         data-hoffset="['100','-671','-509','-382']" data-y="['middle','middle','top','top']"
                         data-voffset="['330','280','784','367']" data-fontsize="['48','56','72','40']"
                         data-lineheight="['56','64','96','50']" data-fontweight="['400','300','700','700']"
                    ...
                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption   tp-resizeme" id="slide-40-layer-18"
                         data-x="['left','center','left','left']"
                         data-hoffset="['250','-607','-327','-263']" data-y="['middle','middle','top','top']"
                         data-voffset="['330','283','795','370']" data-fontsize="['48','34','72','40']"
                         data-lineheight="['56','40','96','50']" data-fontweight="['400','300','700','700']"
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-40-layer-28"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="2" data-xs="0" data-xe="0"
                             ...
                             data-ye="10"><img src="assets/images/revimages/dummy.png" alt=""
                                               data-ww="['723auto','374px','502px','252px']"
                                               data-hh="['723px','374px','366px','258px']"
                                               data-lazyload="assets/images/revimages/special/hp3-element-3.png"
                                               data-no-retina></div>
                    </div>

                    <!-- LAYER NR. 13 -->
                    <div class="tp-caption   tp-resizeme" id="slide-40-layer-30"
                         data-x="['left','left','center','center']"
                         data-hoffset="['808','502','5','0']" data-y="['bottom','bottom','bottom','bottom']"
                         data-voffset="['-143','0','-95','-60']" data-width="none" data-height="none"
                         data-whitespace="nowrap"
                         data-type="image" data-responsive_offset="on"
                         ...
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 9;"><img src="assets/images/revimages/dummy.png" alt=""
                                                  data-ww="['724px','472px','498px','333px']"
                                                  data-hh="['1007px','656px','693px','464px']"
                                                  data-lazyload="assets/images/revimages/special/hp3-element-2.png"
                                                  data-no-retina></div>

                    <!-- LAYER NR. 14 -->
                    <div class="tp-caption   tp-resizeme" id="slide-40-layer-13"
                         data-x="['center','center','left','center']"
                    ...
                    <!-- LAYER NR. 15 -->
                    <div class="tp-caption   tp-resizeme" id="slide-40-layer-3"
                ...
                <li data-index="rs-41"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="assets/images/revimages/dummy.png" data-bgcolor='#dfd2c0' style='background:#dfd2c0'
                         alt=""
                         data-lazyload="assets/images/revimages/transparent.png" data-bgposition="center center"
                         data-bgfit="cover"
                         data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <!-- LAYER NR. 17 -->
                    <div class="tp-caption   tp-resizeme" id="slide-41-layer-17"
                         data-x="['left','center','left','left']"
                         data-hoffset="['100','-671','-509','-382']" data-y="['middle','middle','top','top']"
                         data-voffset="['330','280','784','367']" data-fontsize="['48','56','72','40']"
                         data-lineheight="['56','64','96','50']" data-fontweight="['400','300','700','700']"
                    ...
                    <!-- LAYER NR. 19 -->
                    <div class="tp-caption   tp-resizeme" id="slide-41-layer-18"
                         data-x="['left','center','left','left']"
                         data-hoffset="['250','-607','-327','-263']" data-y="['middle','middle','top','top']"
                         data-voffset="['330','283','795','370']" data-fontsize="['48','34','72','40']"
                         data-lineheight="['56','40','96','50']" data-fontweight="['400','300','700','700']"
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-41-layer-30"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="2" data-xs="0" data-xe="0"
                             data-ys="-10"
                             data-ye="10"><img src="assets/images/revimages/dummy.png" alt=""
                                               data-ww="['998px','707px','787px','453px']"
                                               data-hh="['867px','775px','861px','496px']"
                                               data-lazyload="assets/images/revimages/special/hp3-element-4.png"
                                               data-no-retina></div>
                    </div>

                    <!-- LAYER NR. 21 -->
                    <div class="tp-caption   tp-resizeme" id="slide-41-layer-13"
                         data-x="['center','center','center','center']"
                    ...
                    <!-- LAYER NR. 22 -->
                    <div class="tp-caption   tp-resizeme" id="slide-41-layer-3"
                         data-x="['center','center','center','center']"
                ...
                <div class="row">
                        ...
                        <div class="single-product">
                            ...
                            <div class="single-product__image">
                                <a class="image-wrap" href="shop-product-basic">
                                    <img src="assets/images/products/high-waist-trousers-1-600x800.jpg"
                                         class="img-fluid" alt="">
                                    <img src="assets/images/products/high-waist-trousers-2-600x800.jpg"
                                         class="img-fluid" alt="">
                                </a>
                    ...
                    <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-45">
                        <div class="single-product">
                            ...
                            <div class="single-product__image">
                                <a class="image-wrap" href="shop-product-basic">
                                    <img src="assets/images/products/modern-loafer-patent-1-600x800.jpg"
                                         class="img-fluid" alt="">
                                    <img src="assets/images/products/modern-loafer-patent-2-600x800.jpg"
                                         class="img-fluid" alt="">
                                </a>
                        ...
                        <div class="single-product">
                            ...
                            <div class="single-product__image">
                                <a class="image-wrap" href="shop-product-basic">
                                    ...
                                    <img src="assets/images/products/skinny-jean-2-600x800.jpg" class="img-fluid"
                                         alt="">
                                </a>

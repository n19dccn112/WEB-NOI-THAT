...
<div class="slider-area mb-50 mb-md-30">
    <div id="rev_slider_7_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="homepage-1"
         data-source="gallery"
            ...
            <ul>
                ...
                <li data-index="rs-15"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-15-layer-13" data-x="['center','center','left','left']"
                         ...
                         data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 8; white-space: nowrap; font-size: 16px; line-height: 36px; font-weight: 600; color: #333333; letter-spacing: 3px;font-family:Work Sans;">
                        WOMEN COLLECTION
                    </div>
                    ...
                    <div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-15-layer-20"
                         ...
                         data-y="['top','top','top','top']" data-voffset="['589','529','291','248']" data-width="none"
                    ...
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-15-layer-27"
                         data-x="['left','left','left','left']" data-hoffset="['665','237','125','515']"
                         data-y="['top','top','top','top']" data-voffset="['208','244','486','365']" data-width="none"
                    ...
                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-15-layer-28"
                         data-x="['left','left','left','left']" data-hoffset="['649','326','41','591']"
                         data-y="['top','top','top','top']" data-voffset="['59','24','402','243']" data-width="none"
                         data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                    ...
                    <!-- LAYER NR. 9 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-15-layer-29"
                         data-x="['left','left','left','left']" data-hoffset="['1113','563','342','342']"
                         data-y="['top','top','top','top']" data-voffset="['328','342','628','628']" data-width="none"
                         data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                ...
                <li data-index="rs-16"
                    ...
                    <!-- LAYER NR. 15 -->
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-16-layer-28"
                         data-x="['left','left','left','left']" data-hoffset="['643','1108','381','591']"
                         data-y="['top','top','top','top']" data-voffset="['202','114','530','243']" data-width="none"
                         data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                         data-frames='[{"delay":1070,"speed":1350,"frame":"0","from":"x:50px;opacity:0;","to":"o:1;","ease":"Power2.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                         data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 9;">
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="2" data-xs="0" data-xe="0" data-ys="-10"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-16-layer-13" data-x="['center','center','left','left']"
                         ...
                         data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 11; white-space: nowrap; font-size: 16px; line-height: 36px; font-weight: 600; color: #333333; letter-spacing: 3px;font-family:Work Sans;">
                        MEN COLLECTION
                    </div>
                    ...
                    <div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-16-layer-20"
                         data-x="['center','center','center','left']" data-hoffset="['-762','-364','-246','45']"
                         data-y="['top','top','top','top']" data-voffset="['589','536','305','248']" data-width="none"
                         data-height="none" data-whitespace="nowrap" data-type="button"
                         data-actions='[{"event":"click","action":"simplelink","target":"_blank","url":"\/shop\/","delay":""}]'
                         data-responsive_offset="on"
                         data-frames='[{"delay":1610,"speed":2000,"frame":"0","from":"y:-50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgb(51,51,51);bg:transparent;"}]'
                ...
                <li data-index="rs-17"
                    ...
                    <div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-17-layer-20"
                         data-x="['center','center','center','left']" data-hoffset="['-762','-376','-246','45']"
                         data-y="['top','top','top','top']" data-voffset="['589','316','305','248']" data-width="none"
                         data-height="none" data-whitespace="nowrap" data-type="button"
                         data-actions='[{"event":"click","action":"simplelink","target":"_blank","url":"\/shop\/","delay":""}]'
                         data-responsive_offset="on"
                         data-frames='[{"delay":1610,"speed":2000,"frame":"0","from":"y:-50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgb(51,51,51);bg:transparent;"}]'
        ...
        <div class="row column-five">
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__content">
                        ...
                        <div class="title">
                            <h3> <a href="shop-product-basic.html">Pique Polo Shirt</a></h3>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__image">
                        <a class="image-wrap" href="shop-product-basic.html">
                            <img src="assets/images/products/fashion-5-1-600x800.jpg" class="img-fluid" alt="">
                            <img src="assets/images/products/fashion-5-2-600x800.jpg" class="img-fluid" alt="">
                        </a>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__image">
                        <a class="image-wrap" href="shop-product-basic.html">
                            <img src="assets/images/products/fashion-6-1-600x800.jpg" class="img-fluid" alt="">
                            <img src="assets/images/products/fashion-6-2-600x800.jpg" class="img-fluid" alt="">
                        </a>
            ...
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
                <div class="single-product">
                    ...
                    <div class="single-product__image">
                        <a class="image-wrap" href="shop-product-basic.html">
                            <img src="assets/images/products/fashion-7-1-600x800.jpg" class="img-fluid" alt="">
                            <img src="assets/images/products/fashion-7-2-600x800.jpg" class="img-fluid" alt="">
                        </a>
...
<!-- Mirrored from htmldemo.hasthemes.com/lezada/lezada/index-trending.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 08:04:41 GMT -->
</html>
